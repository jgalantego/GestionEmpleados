...
public class EmpleadoBuilder {
    ...
    // Métodos para ir asignando los valores paso a paso (devuelven el propio Builder)
    ...
    public Empleado build() {
        ...
        if (!validarTextoNoBlanco(id, "ID") || !validarTextoNoBlanco(dni, "DNI") || !validarTextoNoBlanco(nombre, "NOMBRE") ||
                !validarTextoNoBlanco(apellidos, "APELLIDOS") || tipoContrato == null || !validarTextoNoBlanco(password, "CONTRASEÑA")) {
